<template>
	<view class="search-box">
		...
		<!-- <view class="selectItem">
			<view class="paiming" @click="sortType = 2">
				价格升序
			</view>
			<view class="paiming" @click="sortType = 1">
				价格降序
			</view>
			<view class="paiming" @click="sortType = 0">
				价格原序
			</view>
		</view> -->

		<view class="goodsList">
			<view class="goodsItem" v-for="item in filList" :key="item.id">
	...
	export default {
		watch: {
			keyword: {
				...
				handler(newValue) {
					// 搜索
					this.filList = this.itemList.filter(item => {
